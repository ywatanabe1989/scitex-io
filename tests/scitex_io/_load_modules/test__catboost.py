...
class TestLoadCatBoost:
    ...
    def test_regressor_loading_fallback(self, mock_catboost_available):
        ...
        mock_classifier_instance.load_model.side_effect = Exception(
    ...
    def test_kwargs_passed_to_load_model(self, mock_catboost_available):
        ...
        with (
            ...
            mock_instance.load_model.assert_called_once_with(
                "model.cbm", **custom_kwargs
            )
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    assert len(predictions) == 5
                    assert all(
                        isinstance(pred, (int, float, np.number))
    ...
    def test_integration_with_main_load_function(self):
        ...
        try:
            ...
            model = catboost.CatBoostClassifier(
                iterations=5, verbose=False, random_seed=42
            )
            model.fit(X, y)
