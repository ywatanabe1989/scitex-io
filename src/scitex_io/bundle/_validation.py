...
# Schemas live alongside this module (single source of truth). The
# umbrella historically pointed at ``parent.parent / "_schemas"``, a
# non-existent path — fixed here while moving the plumbing into
# scitex_io.bundle so the format-agnostic validation works standalone.
...
class ValidationResult:
    ...
    def raise_if_invalid(self):
        ...
        if self.has_errors:
            from ._types import BundleValidationError
